...
> [!IMPORTANT]
>
> **v0.15.0 ライブラリ再スキャンのお知らせ**: 再帰 leaf-series スキャナーの導入により、ネストされたフォルダの解釈方法が変更されます。アップデート後はライブラリの再スキャンが必要になる場合があり、シリーズ構成が再構築されるライブラリでは、既存の読書進捗やメタデータの関連付けが引き継がれない可能性があります。
>
