...
> [!IMPORTANT]
>
> **v0.15.0 라이브러리 재스캔 안내**: 재귀 leaf-series 스캐너 도입으로 중첩 폴더 해석 방식이 변경됩니다. 업데이트 후 라이브러리 재스캔이 필요할 수 있으며, 시리즈 구성이 다시 잡히는 라이브러리에서는 기존 읽기 진행 상황이나 메타데이터 연결 승계를 보장하지 않습니다.
>
